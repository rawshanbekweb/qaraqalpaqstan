        ...
        >
          <div className="mb-6 inline-flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[14.5px] text-ink-3">Ministrler Keńesi monitoringi</div>
            </div>
          </div>
          ...
          <div className="mt-8 grid max-w-lg grid-cols-3 gap-3">
            {[
              ...
              >
                ...
                <div className="mt-0.5 text-[12.5px] text-ink-3">{s.l}</div>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          <div className="px-7 pt-7 pb-2">
            <div className="mb-1 flex items-center gap-2.5 lg:hidden">
              ...
              <span className="text-[14.5px] font-bold text-ink">Qaraqalpaqstan Monitoring</span>
            </div>
              ...
              {error && (
                ...
                >
                  <div className="flex items-start gap-2 rounded-xl bg-crimson/12 px-3 py-2.5 ring-1 ring-crimson/30">
                    <AlertCircle size={15} className="mt-0.5 shrink-0 text-crimson" />
