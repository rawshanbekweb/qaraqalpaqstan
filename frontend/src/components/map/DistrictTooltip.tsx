      ...
      <div className="glass glass-top-glow overflow-hidden rounded-2xl">
        ...
        <div className="px-3.5 py-3">
          <div className="mb-2.5 flex items-baseline justify-between">
            <span className="text-[11.5px] font-semibold tracking-wider text-ink-3 uppercase">
              Ortasha ósiw
            </span>
            <span
          ...
          <div className="mt-3 space-y-2">
            {shown.map((m, i) => (
              ...
              >
                ...
                />
                <span className="flex-1 truncate text-[13px] text-ink-2">{m.name}</span>
                <span
                ...
                <span
                  className="tnum inline-flex w-13 shrink-0 items-center justify-end gap-0.5 text-[12px]"
            ...
            {shown.length === 0 && (
              <div className="text-[12.5px] text-ink-3">Bul jıl ushın maǵlıwmat joq</div>
            )}
          </div>

          <div className="mt-3 border-t border-hairline/60 pt-2 text-[11.5px] text-ink-3">
