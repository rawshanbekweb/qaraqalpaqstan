...
export const LEGEND_STOPS = [
  { label: "< 80%", color: "rgb(238 100 106)", hint: "reja orınlanbaǵan" },
  { label: "80–92%", color: "rgb(170 52 56)", hint: "artta qalmaqta" },
  { label: "≈ 100%", color: "rgb(74 82 116)", hint: "reja dárejesinde" },
  { label: "> 106%", color: "rgb(64 140 226)", hint: "rejadan joqarı" },
];
